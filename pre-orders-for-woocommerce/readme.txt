...
**If you have any issues at all with the free version of our plugin**, please use the [support tab section](https://wordpress.org/support/plugin/pre-orders-for-woocommerce/), so we can help you resolve them. We are continuing to improve and would love your feedback.

**If you have any issues at all with the pro version of our plugin**, we cannot support them here due to forum policies but can [support them here on our website](https://brightplugins.com/support/).
...
Yes, you can find the documents by [this link](https://brightplugins.com/docs/preorders-for-woocommerce-free-version/).
